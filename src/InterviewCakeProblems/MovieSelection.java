 ...
 * and an array of integers movieLengths (in minutes) and
 * returns a boolean indicating whether there are two numbers in movieLengths
...
public class MovieSelection {
	...
	public boolean twoMoviesAvailable(int flightLength, int[] movieLengths) {
		Set<Integer> seenLengths = new HashSet<Integer>();

		for (int length: movieLengths) {
			int lookingFor = flightLength - length;
			if (seenLengths.contains(lookingFor)) {
				return true;
			}
